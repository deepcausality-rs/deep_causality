...
impl<D, S, T, ST> CurrentTimeIndex for Context<D, S, T, ST>
where
    D: Datable + Clone,
    S: Spatial + Clone,
    T: Temporal + Clone,
...
// Adds the default implementation to Context when the trait is imported. Can be overwritten to customize.
impl<D, S, T, ST> PreviousTimeIndex for Context<D, S, T, ST>
where
    D: Datable + Clone,
    S: Spatial + Clone,
    T: Temporal + Clone,
...
impl<D, S, T, ST> TimeIndexable for Context<D, S, T, ST>
where
    D: Datable + Clone,
    S: Spatial + Clone,
    T: Temporal + Clone,
