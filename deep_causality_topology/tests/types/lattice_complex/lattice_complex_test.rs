...
fn test_lattice_construction() {
    let lattice = LatticeComplex::<2>::new([10, 10], [true, true]); // Torus
...
fn test_lattice_cell_counting() {
    ...
    // Open
    let open = LatticeComplex::<2>::new([3, 3], [false, false]);
    ...
    // Periodic (Torus)
    let periodic = LatticeComplex::<2>::new([3, 3], [true, true]);
...
fn test_lattice_iterators() {
    // 2x2 Open
    let lat = LatticeComplex::<2>::new([2, 2], [false, false]);
...
fn test_wrap_cell_periodic_modulo() {
    ...
    let lattice = LatticeComplex::<2>::torus([5, 5]);
...
fn test_wrap_cell_mixed_boundaries() {
    ...
    let lattice = LatticeComplex::<2>::new([3, 3], [true, false]);
...
#[test]
fn test_max_dim_2d() {
    let lattice = LatticeComplex::<2>::new([4, 4], [false, false]);
...
fn test_boundary_matrix_2d_open() {
    let lattice = LatticeComplex::<2>::square_open(3);
...
fn test_boundary_matrix_2d_torus() {
    let lattice = LatticeComplex::<2>::square_torus(3);
...
fn test_boundary_matrix_squared_is_zero() {
    ...
    let lattice = LatticeComplex::<2>::square_torus(2);
...
fn test_num_cells_zero_dimension_edge_case() {
    ...
    let lattice = LatticeComplex::<2>::new([0, 3], [false, false]);
