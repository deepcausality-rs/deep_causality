...
**What it tests.** `qtt_rank_fitted_dynamic` measures the negative half. A **static** body-fitted
...
necessary but not sufficient. This identifies which half of the Res-5 lever does the work. Analysis: `openspec/notes/archive/cfd-plasma-blackout/gap-2/`.
