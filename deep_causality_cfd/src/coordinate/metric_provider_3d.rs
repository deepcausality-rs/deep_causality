...
//! [`MetricProvider`](super::MetricProvider) (design D8). A compressible marcher written over
...
//!
//! [`CartesianIdentity3d`](super::CartesianIdentity3d) is the capture limit (any geometry, but a curved
