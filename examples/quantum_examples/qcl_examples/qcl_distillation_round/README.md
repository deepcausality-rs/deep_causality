...
The case Lorenz & Tull defer (§7.1), built as two abstractions on the hand-built `[[4,2,2]]` code
and claimed only as far as it is measured.
...
is the part of the noise the ideal recovery does not remove, which a distillation round exists to
