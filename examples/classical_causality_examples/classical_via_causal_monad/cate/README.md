...
Computes the Conditional Average Treatment Effect on `PropagatingProcess<f64, (), PatientContext>` with the [`Alternatable`](../../../../deep_causality_core/src/traits/alternatable/mod.rs) family.
