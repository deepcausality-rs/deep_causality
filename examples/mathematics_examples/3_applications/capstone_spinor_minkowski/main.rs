...
fn build_path_manifold(rapidities: &[FloatType]) -> SimplicialManifold<FloatType, FloatType> {
...
fn read_edge_rapidity(m: &SimplicialManifold<FloatType, FloatType>, e: usize) -> FloatType {
