...
| [hopf_fibration_multivector.rs](hopf_fibration_multivector.rs) | Hopf fibration to project high-dimensional quantum states (spinors) onto a Bloch sphere; aids topological data analysis and quantum-system debugging | `cargo run -p mathematics_examples --example hopf_multivector_examples` |
