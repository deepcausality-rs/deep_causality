...
use deep_causality::prelude::{Dataoid, Node, NodeType, Root, Spaceoid, SpaceTempoid, Tempoid, TimeScale};
...
fn test_root_none()
{
    ...
    let node: Node<Dataoid, Spaceoid, Tempoid, SpaceTempoid> = Node::new(id, NodeType::Datoid(d));
...
fn test_tempoid_some()
{
    ...
    let node: Node<Dataoid, Spaceoid, Tempoid, SpaceTempoid> = Node::new(id, NodeType::Tempoid(tempoid));
...
fn test_spaceiod_some()
{
    ...
    let node: Node<Dataoid, Spaceoid, Tempoid, SpaceTempoid> = Node::new(id, NodeType::Spaceiod(d));
...
fn test_space_tempoid_some()
{
    ...
    let node: Node<Dataoid, Spaceoid, Tempoid, SpaceTempoid> = Node::new(id, NodeType::SpaceTempoid(d));
