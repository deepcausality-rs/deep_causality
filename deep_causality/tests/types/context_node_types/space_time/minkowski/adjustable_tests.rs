...
#[test]
fn test_pdate_fails_non_finite_x() {
...
#[test]
fn test_pdate_fails_non_finite_y() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
...
#[test]
fn test_pdate_fails_non_finite_z() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), 1.0);
    grid.set(PointIndex::new3d(0, 0, 1), 2.0);
...
#[test]
fn test_pdate_fails_non_finite_t() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), 1.0);
    grid.set(PointIndex::new3d(0, 0, 1), 2.0);
...
#[test]
fn test_adjust_fails_non_finite_x() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), f64::NAN);
    grid.set(PointIndex::new3d(0, 0, 1), 2.0);
...
#[test]
fn test_adjust_fails_non_finite_y() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), 1.0);
    grid.set(PointIndex::new3d(0, 0, 1), f64::INFINITY);
...
#[test]
fn test_adjust_fails_non_finite_z() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), 1.0);
    grid.set(PointIndex::new3d(0, 0, 1), 2.0);
...
#[test]
fn test_adjust_fails_non_finite_t() {
    let mut s = MinkowskiSpacetime::new(0, 1.0, 2.0, 3.0, 4.0, TimeScale::Second);
    let grid: ArrayGrid<f64, 4, 4, 4, 4> = ArrayGrid::new(ArrayType::Array3D);
    grid.set(PointIndex::new3d(0, 0, 0), 1.0);
    grid.set(PointIndex::new3d(0, 0, 1), 2.0);
