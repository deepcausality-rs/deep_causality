...
use deep_causality::prelude::{
    Contextoid, ContextoidType, Contextuable, Dataoid, Root, SpaceTempoid, Spaceoid, Tempoid,
    TimeScale,
};
...
fn test_tempoid_some() {
    ...
    let node: Contextoid<Dataoid, Spaceoid, Tempoid, SpaceTempoid> =
        Contextoid::new(id, ContextoidType::Tempoid(tempoid));
...
fn test_spaceiod_some() {
    ...
    let node: Contextoid<Dataoid, Spaceoid, Tempoid, SpaceTempoid> =
        Contextoid::new(id, ContextoidType::Spaceoid(d));
...
fn test_space_tempoid_some() {
    ...
    let node: Contextoid<Dataoid, Spaceoid, Tempoid, SpaceTempoid> =
        Contextoid::new(id, ContextoidType::SpaceTempoid(d));
