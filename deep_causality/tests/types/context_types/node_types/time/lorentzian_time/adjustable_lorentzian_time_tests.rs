...
#[test]
fn test_lorentzian_time_update() {
...
#[test]
fn test_lorentzian_time_adjust_success() {
...
#[test]
fn test_lorentzian_time_adjust_zero_result() {
    let mut t = LorentzianTime::new(1, TimeScale::Second, 0.0);
...
#[test]
fn test_lorentzian_time_adjust_nan_input() {
    let mut t = LorentzianTime::new(1, TimeScale::Second, 1.0);
...
#[test]
fn test_lorentzian_time_adjust_result_is_nan() {
