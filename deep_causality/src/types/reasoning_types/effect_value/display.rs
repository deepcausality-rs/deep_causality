...
impl Display for EffectValue {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            EffectValue::Numeric(n) => write!(f, "Numerical({})", n),
            ...
            EffectValue::MaybeUncertainBool(mub) => write!(f, "MaybeUncertainBool({:?})", mub),
            EffectValue::MaybeUncertainFloat(muf) => write!(f, "MaybeUncertainFloat({:?})", muf),
