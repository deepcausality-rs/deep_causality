...
impl PartialEq for EffectValue {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (EffectValue::ComplexTensor(l0), EffectValue::ComplexTensor(r0)) => l0 == r0,
            (EffectValue::Quaternion(l0), EffectValue::Quaternion(r0)) => l0 == r0,
            (EffectValue::QuaternionTensor(l0), EffectValue::QuaternionTensor(r0)) => l0 == r0,
            (EffectValue::UncertainBool(l0), EffectValue::UncertainBool(r0)) => l0 == r0,
            (EffectValue::UncertainFloat(l0), EffectValue::UncertainFloat(r0)) => l0 == r0,
            (EffectValue::MaybeUncertainBool(l0), EffectValue::MaybeUncertainBool(r0)) => l0 == r0,
            (EffectValue::MaybeUncertainFloat(l0), EffectValue::MaybeUncertainFloat(r0)) => {
                l0 == r0
            }
            (EffectValue::ContextualLink(l0, l1), EffectValue::ContextualLink(r0, r1)) => {
                l0 == r0 && l1 == r1
            }
