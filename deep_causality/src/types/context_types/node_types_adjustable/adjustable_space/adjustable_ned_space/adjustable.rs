...
use crate::prelude::{Adjustable, AdjustableNedSpace};
use dcl_data_structures::grid_type::ArrayGrid;
use dcl_data_structures::prelude::PointIndex;

impl Adjustable<f64> for AdjustableNedSpace {
