...
///
/// let g1 = AdjustableGeoSpace::new(1, 52.520008, 13.404954, 34.0); // Berlin, Germany
/// let g2 = AdjustableGeoSpace::new(2, 48.856613, 2.352222, 35.0);   // Paris, France
///
/// println!("{}", g1);
///
...
/// # Output    
/// ```text
/// AdjustableGeoSpace(id="1", lat=52.520008, lon=13.404954, alt=34m)
/// Distance (approx): 878.84 km
/// ```
#[derive(Constructor, Debug, Clone, PartialEq)]
pub struct AdjustableGeoSpace {
