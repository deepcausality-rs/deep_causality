...
/// - `t`: Time coordinate (in seconds or SI time units)
...
///
/// let s1 = AdjustableLorentzianSpacetime::new(1, 1.0, 0.0, 0.0, 0.0, TimeScale::Second);
/// let s2 = AdjustableLorentzianSpacetime::new(2, 2.0, 3.0, 4.0, 0.0, TimeScale::Second);
///
/// let interval = s1.interval_squared(&s2);
/// println!("Minkowski interval²: {interval}");
/// ```
#[derive(Constructor, Debug, Clone, PartialEq)]
pub struct AdjustableLorentzianSpacetime {
    id: u64,
