...
#[test]
fn test_neg_zero() {
    let neg_zero = <DoubleFloat as Float>::neg_zero();
...
#[test]
fn test_min_value() {
    let min = <DoubleFloat as Float>::min_value();
    assert!(min.hi() < 0.0);
...
fn test_min_positive_value() {
    let min_pos = <DoubleFloat as Float>::min_positive_value();
...
#[test]
fn test_max_value() {
    let max = <DoubleFloat as Float>::max_value();
    assert!(max.hi() > 0.0);
...
#[test]
fn test_epsilon() {
    let eps = <DoubleFloat as Float>::epsilon();
    assert!(eps.hi() > 0.0);
}
...
fn test_is_subnormal() {
    let x = DoubleFloat::from_f64(f64::MIN_POSITIVE / 2.0);
...
#[test]
fn test_round_down() {
    let x = DoubleFloat::from_f64(3.4);
    assert!((Float::round(x).hi() - 3.0).abs() < EPSILON);
}

#[test]
fn test_trunc() {
    let x = DoubleFloat::from_f64(3.9);
...
fn test_mul_add() {
    ...
    let a = DoubleFloat::from_f64(3.0);
    let b = DoubleFloat::from_f64(4.0);
    // x * a + b = 2 * 3 + 4 = 10
...
#[test]
fn test_sqrt() {
    let x = DoubleFloat::from_f64(9.0);
...
#[test]
fn test_cbrt() {
    let x = DoubleFloat::from_f64(27.0);
...
fn test_cbrt_negative() {
    let x = DoubleFloat::from_f64(-8.0);
    let result = Float::cbrt(x);
...
fn test_hypot() {
    ...
    let y = DoubleFloat::from_f64(4.0);
...
fn test_log() {
    let x = DoubleFloat::from_f64(8.0);
    let base = DoubleFloat::from_f64(2.0);
...
fn test_max() {
    let x = DoubleFloat::from_f64(3.0);
    let y = DoubleFloat::from_f64(5.0);
