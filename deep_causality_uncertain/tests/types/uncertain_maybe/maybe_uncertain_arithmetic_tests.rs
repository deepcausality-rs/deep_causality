...
rusty_fork_test! {
    ...
    fn test_add_both_some() {
        let a = MaybeUncertain::from_value(3.0);
        let b = MaybeUncertain::from_value(4.0);
        let res = a + b;
    ...
    fn test_add_one_none() {
        let a = MaybeUncertain::from_value(3.0);
        let b = MaybeUncertain::always_none();
        let res = a + b;
    ...
    fn test_add_both_none() {
        let a = MaybeUncertain::always_none();
        let b = MaybeUncertain::always_none();
        let res = a + b;
        assert_eq!(res.sample().unwrap(), None);
    }
    ...
    fn test_div_both_some() {
        let a = MaybeUncertain::from_value(12.0);
        let b = MaybeUncertain::from_value(4.0);
        let res = a / b;
