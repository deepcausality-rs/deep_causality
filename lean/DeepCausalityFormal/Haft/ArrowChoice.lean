...
Rust source: `deep_causality_unified_math/deep_causality_haft/src/arrow/choice.rs` (`Left`, `Right`, `Choice`, `Fanin` and the
...
Rust witness: `deep_causality_unified_math/deep_causality_haft/tests/formalization_lean/arrow_choice_tests.rs`.
