...
Rust source: `deep_causality_unified_math/deep_causality_haft/src/arrow/arrow_term.rs` (`ArrowCore`, `ArrowVal`, `ArrowCore::interpret`).
...
Rust witness: `deep_causality_unified_math/deep_causality_haft/tests/formalization_lean/arrow_term_tests.rs`.
