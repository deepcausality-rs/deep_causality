...
Rust source: `deep_causality_unified_math/deep_causality_haft/src/arrow/` — trait `Arrow` with combinators
...
Rust witness: `deep_causality_unified_math/deep_causality_haft/tests/formalization_lean/arrow_tests.rs`.
