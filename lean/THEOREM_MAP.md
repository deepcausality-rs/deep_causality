...
| `algebra.euclidean.remainder_nonneg` | `b ≠ 0 → 0 ≤ a % b`; `rem_euclid` is non-negative whatever the signs | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_remainder_nonneg` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_remainder_nonneg` | ✓ | n/a |
| `algebra.euclidean.remainder_lt_divisor` | `b ≠ 0 → a % b < \|b\|`; the termination argument for the Euclidean algorithm, covering the negative divisor the first step can be called with | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_remainder_lt_divisor` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_remainder_lt_divisor` | ✓ | n/a |
| `algebra.euclidean.gcd_dvd_left` | `gcd(a,b) ∣ a` | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_gcd_dvd_left` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_gcd_divides_left` | ✓ | n/a |
| `algebra.euclidean.gcd_dvd_right` | `gcd(a,b) ∣ b` | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_gcd_dvd_right` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_gcd_divides_right` | ✓ | n/a |
| `algebra.euclidean.gcd_nonneg` | `0 ≤ gcd(a,b)`; the canonical associate is the non-negative one | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_gcd_nonneg` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_gcd_nonneg` | ✓ | n/a |
| `algebra.euclidean.gcd_zero_right` | `gcd(a,0) = \|a\|`; the base case of the recursion | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_gcd_zero_right` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_gcd_zero_right` | ✓ | n/a |
| `algebra.euclidean.integers_not_field` | `¬∃ x : ℤ, 2x = 1`; why `Invertible` is withheld from ℤ | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_integers_not_field` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_integers_are_not_a_field` | ✓ | n/a |
| `rational.field.mul_inv` | `q ≠ 0 → q · q⁻¹ = 1`; ℚ is a field | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_mul_inv` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_mul_inv` | ✓ | n/a |
| `rational.field.mul_comm` | `a·b = b·a` over ℚ | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_mul_comm` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_mul_comm` | ✓ | n/a |
| `rational.field.mul_assoc` | `(a·b)·c = a·(b·c)` over ℚ | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_mul_assoc` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_mul_assoc` | ✓ | n/a |
| `rational.field.distrib` | `a·(b+c) = a·b + a·c` over ℚ | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_distrib` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_distrib` | ✓ | n/a |
| `rational.abelian_group.add_neg` | `a + (−a) = 0` over ℚ | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_add_neg` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_add_neg` | ✓ | n/a |
| `rational.canonical.den_pos` | `0 < q.den`; canonical-form invariant 1 | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_den_pos` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_denominator_is_positive` | ✓ | n/a |
| `rational.canonical.coprime` | `gcd(num, den) = 1`; canonical-form invariant 2, so equality is structural | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_coprime` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_numerator_and_denominator_are_coprime` | ✓ | n/a |
| `rational.order.dense` | `a < b → a < (a+b)/2 < b`; ℚ has no successor | proved | `DeepCausalityFormal/Rational/Rational.lean :: rational_dense` | `deep_causality_num_rational/tests/formalization_lean/rational_tests.rs :: test_density` | ✓ | n/a |
