...
| `algebra.euclidean.remainder_lt_divisor` | `0 < b → a % b < b`; the termination argument for the Euclidean algorithm | proved | `DeepCausalityFormal/Algebra/EuclideanDomain.lean :: euclidean_remainder_lt_divisor` | `deep_causality_algebra/tests/formalization_lean/domain_euclidean_tests.rs :: test_remainder_lt_divisor` | ✓ | n/a |
