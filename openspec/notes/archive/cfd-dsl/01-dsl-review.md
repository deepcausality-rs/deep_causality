...
`openspec/changes/archive/2026-07-05-add-cfd-study-dsl-and-examples/` (one scope
correction recorded in that change's design D3: `run_owned` is MarchPipeline-only,
because the uncertain config carries no mesh). Related:
