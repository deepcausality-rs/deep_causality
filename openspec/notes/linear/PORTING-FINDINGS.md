...
`openspec/specs/neumann-poisson/spec.md` names this function normatively, and phase 5 repoints every
...
`HKT-LAW-FINDINGS.md`. Nothing outside the two crates' own tests uses either, so the omission reaches
no consumer.
