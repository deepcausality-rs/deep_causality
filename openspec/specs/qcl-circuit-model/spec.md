...
# qcl-circuit-model Specification

## Purpose
Compositional models in QC as circuits: boxes, typed wires, the box-to-node grouping, the induced DAG, and the two semantics functors, exact over 𝔽₂ and rationals and numeric at the Kraus level under caps. Synced 2026-09-15 from the change `add-qcl2-abstraction`.
## Requirements
