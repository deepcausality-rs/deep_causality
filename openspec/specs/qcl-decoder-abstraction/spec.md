...
# qcl-decoder-abstraction Specification

## Purpose
The decoder as an abstraction from a physical circuit to its detector error model: the model as a classical causal model, the Stim text constructor behind a feature, the decoder as a black-box stochastic matrix, naturality as decoder-model validation, and logical attribution. Synced 2026-09-15 from the change `add-qcl2-abstraction`.
## Requirements
