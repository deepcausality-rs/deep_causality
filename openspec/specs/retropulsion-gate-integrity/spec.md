# retropulsion-gate-integrity Specification

## Purpose
Integrity requirements for the retropulsion example's gate sequences: every gate must read a measurement that can fail.
