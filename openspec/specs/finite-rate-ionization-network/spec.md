# finite-rate-ionization-network Specification

## Purpose
The uncalibrated two-way finite-rate ionization network: the three-channel RP-1232 replacement for the calibrated Saha surrogate (associative ionization with dissociative recombination, thresholded electron impact, and a lagged neutral atom pool), evaluated per cell in the CfdFlow coupling with no calibration target anywhere.
