...
# qcl-hypothesis Specification

## Purpose
Restored 2026-09-09 from the archived change `add-qcl` (`openspec/changes/archive/2026-09-03-add-qcl/specs/qcl-hypothesis/spec.md`), whose archive step did not merge its delta; the text is the archived delta as written.
## Requirements
