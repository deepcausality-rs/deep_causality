# haft-formalization-docs Specification
...
#### Scenario: The stated count tracks the table
- **WHEN** the intro prose's spelled-out law count is compared against the number of table rows
- **THEN** they agree
