...
# qcl-abstraction Specification

## Purpose
Abstractions between compositional models after Lorenz & Tull (arXiv:2602.16612): type alignments with sections, query signatures, the abstraction object, the naturality check with its two-sided diamond bound, the structural precheck, the CSS code as an abstraction, composition under a law with two computed constants, and the three consumer chains. Synced 2026-09-15 from the change `add-qcl2-abstraction`.
## Requirements
