...
# qcl-fault-tolerance Specification

## Purpose
Fault sets as capped query signatures, exact fault propagation through every Table 1 gate in the algebra of the logical Z̄s, the fault-tolerance predicate over the enlarged signature, the Haruna filter, and the narrowed fault-tolerance claim. Synced 2026-09-15 from the change `add-qcl2-abstraction`.
## Requirements
