...
**The acceptance bar is tier 3 — reproducing the real-world experiment rankings** (OB / Sock Shop). The toy and synthetic tiers are smoke tests that gate progress cheaply; they are necessary but not sufficient. Three tiers, fastest-to-run first:
