...
- The 3D causal-fluid pipeline (TopologicalSignature, RollingHistory, FluidContext, SURD wiring, NS kernels) — separate change set sequence per [`notes/3DCausalFluidDynamics.md`](../../../notes/archive/cfd/3DCausalFluidDynamics.md).
