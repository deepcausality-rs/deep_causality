...
- [ ] 4.15 Verify: the crate's test suite is green at full coverage under both build systems, and the unused-dependency check passes — this gates every task in group 5
