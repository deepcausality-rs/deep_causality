...
impl<R: UncertainScalar> BitAnd for UncertainBool<R> {
    type Output = Self;
...
impl<R: UncertainScalar> BitOr for UncertainBool<R> {
    type Output = Self;
...
impl<R: UncertainScalar> BitXor for UncertainBool<R> {
    type Output = Self;
...
impl<R: UncertainScalar> Not for UncertainBool<R> {
    type Output = Self;
