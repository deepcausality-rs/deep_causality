...
//! `BadWitness` test types from `deep_causality_algebra::utils_tests::utils_iso_witness_tests`.

use deep_causality_algebra::iso::witness::test_support::assert_witness_group_iso_law;
