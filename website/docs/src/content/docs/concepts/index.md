...
- **[Unified Math](/concepts/uniform-math/)** — one Functor/Monad/CoMonad surface across tensors, matrices, multivectors, manifolds, and effect propagation, on one algebraic tower running from the naturals to the octonions.
