...
- **Counterfactuals as a first-class operation**: `alternate_value` rewrites the value at any point in the chain. The same machinery handles factual and counterfactual evaluation.
