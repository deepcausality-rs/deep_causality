...
- **[Hello, Causal Monad](/getting-started/hello-causal-monad/)** — the smallest program that exercises `pure` and `bind`. Walk a value through a three-step chain and look at what flowed.
