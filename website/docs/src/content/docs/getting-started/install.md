...
- Containers and kernels: [`deep_causality_linear`](https://github.com/deepcausality-rs/deep_causality/tree/main/deep_causality_linear) (matrices and vectors), [`deep_causality_tensor`](https://github.com/deepcausality-rs/deep_causality/tree/main/deep_causality_tensor) (N-index tensors and tensor trains), [`deep_causality_multivector`](https://github.com/deepcausality-rs/deep_causality/tree/main/deep_causality_multivector) (Clifford algebra), [`deep_causality_topology`](https://github.com/deepcausality-rs/deep_causality/tree/main/deep_causality_topology) (complexes, manifolds, exterior calculus).
