...
From the corridor's coupling stack, `examples/avionics_examples/src/shared/world.rs:154-205`:
...
`powered_descent_coupling` (`world.rs:266-281`) is the same stack extended with
the burn stages.
