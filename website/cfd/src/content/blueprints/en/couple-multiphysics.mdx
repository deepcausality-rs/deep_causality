...
From the corridor coupling stack, `examples/avionics_examples/src/shared/world.rs:154-205`:
...
significant figures while the trajectory outcome varies by nearly a factor of ten:
