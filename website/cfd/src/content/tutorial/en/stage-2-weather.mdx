...
[PASS] (4) the INS does not behave as assumed in the cold: polar-winter mean
       blackout drift 58.71 m vs standard-day 41.60 m (1.41x; gate requires 1.2x)
[PASS] (4b) the cold effect is statistically resolved: polar-standard
       separation 17.11 m vs combined sigma 3.01 m (5.7 sigma; gate requires 2)
```
...
scatter of 15 m a 17.11 m separation would carry no information, and the gate
would pass regardless. Gate 4b requires the separation to clear two combined
standard deviations; it clears nearly six.
