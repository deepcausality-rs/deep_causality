...
A two-way case exists and is harder. The retropulsion work imprints a plume on
the marched layer and contracts the drag decrement from the evolved field. Its
de-risk measurement is recorded on [capability boundaries](/boundaries/#srp),
