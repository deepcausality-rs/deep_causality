...
Five short pages. Install first, then four "hello, X" programs that each isolate one moving part. By the end you have written, evaluated, and composed every primitive the library is built on.
...
- **[Hello, Effect Propagation](/docs/getting-started/hello-effect-propagation/)** — how the Causaloid, the Causal Monad, and the propagating-effect types compose into one chain.
