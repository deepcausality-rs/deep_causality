...
order: 13
category: medicine
source: examples/causal_intervention_examples/counterfactual_resection_intervention/main.rs
crates:
  - deep_causality_core
further:
