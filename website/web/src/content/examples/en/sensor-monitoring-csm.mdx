...
The full crate lives at [`examples/csm_examples/`](https://github.com/deepcausality-rs/deep_causality/tree/main/examples/csm_examples). The basic example covered on this page is one of three siblings:
