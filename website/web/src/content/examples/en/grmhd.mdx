---
title: General-relativistic magnetohydrodynamics as a five-stage CausalFlow pipeline
domain: Astrophysics
summary: Couple a GR solver, a coupling layer, and an MHD solver through a CausalFlow chain. Curvature picks the metric; the metric drives the plasma physics; stability falls out at the end.
order: 9
category: physics
crates:
  - deep_causality
...
[`main.rs:56`](https://github.com/deepcausality-rs/deep_causality/blob/main/examples/physics_examples/grmhd/main.rs#L56).
