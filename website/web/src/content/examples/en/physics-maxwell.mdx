...
This example lives at [`maxwell`](https://github.com/deepcausality-rs/deep_causality/tree/main/examples/physics_examples/maxwell). It is the simplest demonstration of monadic composition over a physics chain: each step is a pure function from one physical state to the next, and `bind` glues them.
