...
- `model.rs`: `MaxwellState`, `PlaneWaveConfig`, and the four step functions. The implementation uses the [`deep_causality_multivector`](https://github.com/deepcausality-rs/deep_causality/tree/main/deep_causality_multivector) crate for geometric-algebra operations.
