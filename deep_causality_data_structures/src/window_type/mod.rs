...
/// # #[cfg(feature = "unsafe")]
/// # {
/// use deep_causality_data_structures::window_type::new_with_unsafe_vector_storage;
///
...
/// # #[cfg(feature = "unsafe")]
/// # {
/// use deep_causality_data_structures::window_type::new_with_unsafe_array_storage;
///
